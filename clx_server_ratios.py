...
#
# auto generated TopDown/TMAM 4.1 description for Intel Xeon Scalable Processors 2nd gen (code named Cascade Lake)
...
cache line."""
    level = 4
    htoff = False
    sample = ['MEM_LOAD_L3_HIT_RETIRED.XSNP_HITM', 'OCR.DEMAND_RFO.L3_HIT.HITM_OTHER_CORE']
    errcount = 0
    sibling = None
    server = False
    metricgroup = ['Data_Sharing', 'Offcore']
