...
#
# auto generated TopDown/TMAM 4.1 description for Intel 6th/7th gen Core (code named Skykale/Kabylake/Coffeelake)
...
cache line."""
    level = 4
    htoff = False
    sample = ['MEM_LOAD_L3_HIT_RETIRED.XSNP_HITM', 'OFFCORE_RESPONSE.DEMAND_RFO.L3_HIT.SNOOP_HITM']
    errcount = 0
    sibling = None
    server = False
    metricgroup = ['Data_Sharing', 'Offcore']
