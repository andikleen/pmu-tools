...
#
# auto generated TopDown/TMAM 3.098 description for Intel 6th gen Core (code Named Skykale)
...
node may overlap with its siblings."""
    ...
    def compute(self, EV):
        try:
            self.val = (EV("INT_MISC.CLEAR_RESTEER_CYCLES", 3) + 10 * EV("BACLEARS.ANY", 3)) / CLKS(self, EV, 3 )
            self.thresh = (self.val > 0.05) and self.parent.thresh
        except ZeroDivisionError:
