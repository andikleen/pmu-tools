...
Update: As of kernel 3.12 basically all PEBS information can be accessed natively with perf. So pebs-grabber is obsolete. However it's still useful if you're on an older kernel and maybe for some special applications.
