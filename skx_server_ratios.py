...
#
# auto generated TopDown/TMAM 4.11-full-perf description for Intel Xeon Scalable Processors (code named Skylake Server)
...
def Few_Uops_Executed_Threshold(self, EV, level):
    return self.Retiring.compute(EV) * EV("EXE_ACTIVITY.2_PORTS_UTIL", level)
