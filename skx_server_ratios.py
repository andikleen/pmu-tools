# -*- coding: latin-1 -*-
#
# auto generated TopDown/TMA 4.6-full-perf description for Intel Xeon Scalable Processors (code named Skylake Server)
...
class False_Sharing:
    ...
    def compute(self, EV):
        try:
            self.val = (Mem_Remote_HitM_Cost(self, EV, 4) * OCR_all_rfo_l3_miss_remote_hitm(self, EV, 4) + Mem_XSNP_HitM_Cost(self, EV, 4) * OCR_all_rfo_l3_hit_snoop_hitm(self, EV, 4)) / CLKS(self, EV, 4)
            self.thresh = (self.val > 0.05) and self.parent.thresh
        except ZeroDivisionError:
...
ofinjected blend uops out of all Uops Issued -- the Count
...
to four uops. This highly-correlates with the number of uops
...
class Setup:
    def __init__(self, r):
        ...
        o["Memory_Synchronization"].Local_DRAM = o["Local_DRAM"]
        ...
        o["Memory_Synchronization"].Remote_DRAM = o["Remote_DRAM"]
        ...
        o["Other_Bottlenecks"].Local_DRAM = o["Local_DRAM"]
        ...
        o["Other_Bottlenecks"].Remote_DRAM = o["Remote_DRAM"]
