...
#
# auto generated TopDown/TMAM 4.1 description for Intel 3rd gen Core (code named IvyBridge)
...
cache line."""
    level = 4
    htoff = False
    sample = ['MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HITM', 'OFFCORE_RESPONSE.DEMAND_RFO.LLC_HIT.HITM_OTHER_CORE']
    errcount = 0
    sibling = None
    server = False
    metricgroup = ['Data_Sharing', 'Offcore']
