...
# CBO:
     ...
     "CBO.AVG_TOR_DRDS_MISS_WHEN_NE": {
          ...
          "Equation": "(TOR_OCCUPANCY.MISS_OPCODE / COUNTER0_OCCUPANCY{edge_det=1,thresh=0x1}) with:Cn_MSR_PMON_BOX_FILTER.opc=0x182",
     ...
     "CBO.AVG_TOR_DRDS_WHEN_NE": {
          ...
          "Equation": "(TOR_OCCUPANCY.OPCODE / COUNTER0_OCCUPANCY{edge_det=1,thresh=0x1}) with:Cn_MSR_PMON_BOX_FILTER.opc=0x182",
          "Filter": "CBoFilter[31:23]",
	  "Obscure": 1,
     },
