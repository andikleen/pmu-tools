...
#
# auto generated TopDown/TMAM 4.1 description for Intel Xeon E5 v4 (code named Broadwell EP)
...
improve the latency and increase performance."""
    level = 5
    htoff = False
    sample = ['MEM_LOAD_UOPS_L3_MISS_RETIRED.LOCAL_DRAM']
    errcount = 0
    sibling = None
    server = False
    metricgroup = ['Server']
...
caused often due to non-optimal NUMA allocations."""
    level = 5
    htoff = False
    sample = ['MEM_LOAD_UOPS_L3_MISS_RETIRED.REMOTE_DRAM']
    errcount = 0
    sibling = None
    server = False
    metricgroup = ['Server']
...
often due to non-optimal NUMA allocations."""
    level = 5
    htoff = False
    sample = ['MEM_LOAD_UOPS_L3_MISS_RETIRED.REMOTE_HITM', 'MEM_LOAD_UOPS_L3_MISS_RETIRED.REMOTE_FWD']
    errcount = 0
    sibling = None
    server = False
...
cache line."""
    level = 4
    htoff = False
    sample = ['MEM_LOAD_UOPS_L3_HIT_RETIRED.XSNP_HITM', 'MEM_LOAD_UOPS_L3_MISS_RETIRED.REMOTE_HITM', 'OFFCORE_RESPONSE.DEMAND_RFO.LLC_HIT.HITM_OTHER_CORE', 'OFFCORE_RESPONSE.DEMAND_RFO.LLC_MISS.REMOTE_HITM']
    errcount = 0
    sibling = None
    server = False
    metricgroup = ['Data_Sharing', 'Offcore']
