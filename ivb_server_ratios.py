...
#
# auto generated TopDown/TMAM 4.1 description for Intel Xeon E5 v2 (code named IvyBridge EP)
...
such as modified locked variables; and false sharing."""
    level = 4
    htoff = False
    sample = ['MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HITM', 'MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_MISS']
    errcount = 0
    sibling = None
    server = False
...
multithreaded performance."""
    level = 4
    htoff = False
    sample = ['MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HIT']
    errcount = 0
    sibling = None
    server = False
    metricgroup = ['Offcore']
...
caused often due to non-optimal NUMA allocations."""
    level = 5
    htoff = False
    sample = ['MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_DRAM']
    errcount = 0
    sibling = None
    server = False
    metricgroup = ['Server']
...
often due to non-optimal NUMA allocations."""
    level = 5
    htoff = False
    sample = ['MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_HITM', 'MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_FWD']
    errcount = 0
    sibling = None
    server = False
...
cache line."""
    level = 4
    htoff = False
    sample = ['MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HITM', 'MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_HITM', 'OFFCORE_RESPONSE.DEMAND_RFO.LLC_HIT.HITM_OTHER_CORE', 'OFFCORE_RESPONSE.DEMAND_RFO.LLC_MISS.REMOTE_HITM']
    errcount = 0
    sibling = None
    server = False
    metricgroup = ['Data_Sharing', 'Offcore']
