...
#
# auto generated TopDown/TMAM 3.31-full description for Intel 5th gen Core / Core M (code named Broadwell)
...
lines."""
    level = 4
    htoff = False
    sample = ['MEM_LOAD_UOPS_L3_HIT_RETIRED.XSNP_HITM:pp', 'OFFCORE_RESPONSE:request=DEMAND_RFO:response=L3_HIT.SNOOP_HITM']
    errcount = 0
    sibling = None
    server = False
    metricgroup = ['Data_Sharing']
